...
const ConfirmationModal = ({ 
  ...
  <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
    ...
    <div className="bg-white rounded-lg w-full max-w-sm sm:max-w-md py-6 sm:py-8 px-4 sm:px-6 relative z-10 flex flex-col items-center">
      <div className="mb-4">
      ...
      <h3 className="text-[#F5385D] font-bold text-lg sm:text-xl mb-4 sm:mb-6 text-center">{title}</h3>
