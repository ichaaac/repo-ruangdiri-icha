	...
	const handleSave = () => {
		...
		if (formData.newPassword && formData.newPassword === formData.oldPassword) {
			newErrors.newPassword =
				"Tidak bisa menggunakan password yang sudah dipakai";
			hasError = true;
		}
					...
					<div className="flex flex-col gap-1">
						<div className="flex items-center gap-1">
							<span
								...
								style={{
									color: validationResults.hasMinLength ? "#9BCA61" : "#EE4266",
								}}
							>
						...
						<div className="flex items-center gap-1">
							<span
								className="material-icons text-[14px] mr-1"
								style={{
									color: validationResults.hasUpperCase ? "#9BCA61" : "#EE4266",
								}}
							>
					...
					<div className="flex flex-col gap-1">
						<div className="flex items-center gap-1">
							<span
								className="material-icons text-[14px] mr-1"
								style={{
									color: validationResults.hasNumber ? "#9BCA61" : "#EE4266",
								}}
							>
						...
						<div className="flex items-center gap-1">
							<span
								className="material-icons text-[14px] mr-1"
								style={{
									color: validationResults.hasSpecialChar
										? "#9BCA61"
										: "#EE4266",
								}}
							>
