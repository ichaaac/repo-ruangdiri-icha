...
    if (country === 'ID') {
      // ENHANCED: Perbarui rentang digit untuk mencakup nomor telepon rumah (landline) dan ponsel.
      // Nomor signifikan (nationalNumber) di Indonesia umumnya memiliki 8-12 digit.
      // Contoh landline: (021) 4895164 -> nationalNumber '214895164' (9 digit)
      // Contoh mobile: 081234567890 -> nationalNumber '81234567890' (11 digit)
      if (digitCount < 8 || digitCount > 12) {
        return "Nomor telepon Indonesia harus 8-12 digit (tanpa 0 di depan)";
      }
      // Cek prefix yang umum (opsional, karena isValid() sudah cukup kuat)
