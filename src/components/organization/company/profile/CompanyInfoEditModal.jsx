// src/components/organization/company/profile/CompanyInfoEditModal.jsx
...
const CompanyInfoEditModal = ({ onClose, userData }) => {
      ...
      <div className="bg-white rounded-lg overflow-hidden shadow-lg w-[520px] max-w-full">
        <div className="p-6">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-xl font-semibold text-primary">Edit Informasi Perusahaan</h2>
            <button 
              type="button" 
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Jalan Sudirman No. 123, Jakarta"
                />
                {errors.address && (
                  <span className="text-xs text-red-500 mt-1">
