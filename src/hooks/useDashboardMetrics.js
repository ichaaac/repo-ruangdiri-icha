...
    queryFn: async () => {
      const params = `?page=1&limit=1&month=${currentDate.month}&year=${currentDate.year}&screeningStatus=at_risk`
...
    queryFn: async () => {
      const params = `?page=1&limit=1&month=${currentDate.month}&year=${currentDate.year}&screeningStatus=not_screened`
      const res = await apiClient.get(`${endpoint}${params}`)
      return res.data
    },
    refetchOnWindowFocus: false,
...
    queryFn: async () => {
      const params = `?page=1&limit=1&month=${currentDate.month}&year=${currentDate.year}&counselingStatus=0`
      const res = await apiClient.get(`${endpoint}${params}`)
      return res.data
    },
    refetchOnWindowFocus: false,
