        ...
        <div className="mx-auto px-6 lg:px-[72px] py-6 flex items-center justify-center gap-2" style={{ maxWidth: 1440 }}>
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
            <g clipPath="url(#clip0_footer)">
              <path d="M10.0003 18.3332C14.6027 18.3332 18.3337 14.6022 18.3337 9.99984C18.3337 5.39746 14.6027 1.6665 10.0003 1.6665C5.39795 1.6665 1.66699 5.39746 1.66699 9.99984C1.66699 14.6022 5.39795 18.3332 10.0003 18.3332Z" stroke="#9CA3AF" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
              <path d="M10.2005 13.9582C8.25052 13.9582 6.66719 12.1832 6.66719 10.0082C6.66719 7.83317 8.25052 6.05817 10.2005 6.05817C11.1588 6.05817 12.0838 6.4165 12.8088 7.03317C13.0672 7.25817 13.0922 7.65817 12.8672 7.9165C12.6422 8.17484 12.2422 8.19985 11.9838 7.97485C11.4922 7.54151 10.8588 7.29985 10.2005 7.29985C8.70883 7.29985 7.49219 8.5165 7.49219 10.0082C7.49219 11.4998 8.70883 12.7165 10.2005 12.7165C10.8505 12.7165 11.4922 12.4748 11.9838 12.0415C12.2422 11.8165 12.6422 11.8415 12.8672 12.0998C13.0922 12.3582 13.0672 12.7582 12.8088 12.9832C12.0838 13.6082 11.1588 13.9582 10.2005 13.9582Z" fill="#9CA3AF" />
            </g>
            <defs>
