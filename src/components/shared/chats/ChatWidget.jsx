// src/components/shared/chats/ChatWidget.jsx - RESPONSIVE FIXED
...
const ChatWidget = ({ 
  ...
  // 🔥 RESPONSIVE POSITION CLASSES - FIXED
  const getPositionClasses = () => {
    switch (position) {
      ...
      default:
        return 'fixed bottom-6 right-6 z-50'; // Default fallback
    }
  };
  ...
  return (
    <div className={`${getPositionClasses()} ${className}`} ref={chatRef}>
      ...
      {/* 🔥 RESPONSIVE FLOATING BUTTON - FIXED */}
      <motion.button
