...
const Stage1Content = ({ onScrollDown }) => {
  return (
    <motion.div 
      className="w-96 left-[946px] top-[356px] absolute inline-flex flex-col justify-center items-end gap-7"
      initial={{ opacity: 0, x: 50 }}
      animate={{ opacity: 1, x: 0 }}
      transition={{ duration: 0.8, ease: "easeOut" }}
    >
      <motion.div 
        className="self-stretch justify-start text-white text-base font-medium leading-tight"
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        transition={{ delay: 0.3, duration: 0.6 }}
      >
        Kamu akan memulai proses skrining status kesehatan mental. Skrining ini dapat membantu kamu untuk mengetahui gambaran besar mengenai status kesehatan mental kamu. Terdapat 21 pertanyaan dengan pilihan jawaban yang harus kamu pilih sesuai dengan apa yang kamu rasakan.
        <br/><br/>
  ...
  return (
    ...
    >
      <motion.div 
        ...
        transition={{ delay: 0.3, duration: 0.6 }}
      >
        Hasil skrining kamu tidak dapat menjadi acuan diagnosis utama. Penegakkan diagnosis hanya didapatkan dari profesional. Jawaban kamu akan kami gunakan secara kolektif dan anonim untuk pengembangan alat tes dan platform Ruang Diri. Jika kamu memahami dan menyetujui hal di atas, ceklis pernyataan di bawah ini dan silahkan klik tombol 'Mulai'
      </motion.div>
      ...
      >
        ...
        <div className="justify-start text-white text-base font-medium leading-tight">
          Saya setuju
        </div>
      </motion.div>
      ...
      >
        <div className={`text-center justify-start text-base font-bold leading-[74px] ${
...
const WelcomeView = ({ onStart, onExit }) => {
  ...
  return (
    <div className="w-full h-screen relative bg-white overflow-hidden">
      ...
      <div className="w-full max-w-[1400px] h-[658px] left-[20px] top-[127px] absolute bg-zinc-300 rounded-[10px] max-md:left-2 max-md:w-[calc(100%-1rem)]" />
      
      {/* Main background image */}
      <img 
        className="w-[1834.38px] h-[697.74px] left-[-351.54px] top-[119.57px] absolute object-cover max-md:w-full max-md:h-full max-md:left-0 max-md:top-0" 
      ...
      <div 
        className="w-[1195.38px] h-[658px] left-[224.62px] top-[127px] absolute max-md:w-full max-md:h-full max-md:left-0 max-md:top-0"
        style={{
