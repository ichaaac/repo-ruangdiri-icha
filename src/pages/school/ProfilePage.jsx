			...
			<div className="flex flex-wrap gap-10 max-w-full w-full md:w-[490px]">
				<div className="flex flex-col grow shrink-0 basis-0 w-fit">
					...
					<div className="flex flex-col md:flex-row gap-5 justify-between mt-7">
						<div
							className={`w-[120px] h-[120px] md:w-[148.39px] md:h-[148.39px] rounded-full border-4 ${profilePhoto ? "border-accent" : "border-[#d9d9d9]"} flex items-center justify-center relative mx-auto md:mx-0`}
						>
							{profilePhoto ? (
								<img
				...
				<div className="flex flex-col md:flex-row gap-5">
					<div className="w-full md:w-6/12">
						<div className="flex flex-col items-start w-full text-xs leading-5 text-zinc-500">
							...
							<label className="mt-5 text-zinc-400">Nama Sekolah</label>
							{isEditing ? (
								<input
									type="text"
									name="schoolName"
							...
							<label className="mt-8 text-zinc-400">Alamat</label>
							{isEditing ? (
								<textarea
									name="address"
					...
					<div className="w-full md:w-6/12 md:ml-5">
						<div className="flex flex-col mt-6 md:mt-10 w-full text-xs leading-5">
							<label className="self-start text-zinc-400">Email</label>
							{isEditing ? (
								<input
									type="email"
									name="email"
