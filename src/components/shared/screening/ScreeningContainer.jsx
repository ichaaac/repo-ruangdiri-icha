 ...
 */
const ScreeningContainer = ({ user, onComplete, onExit, userRole = "student" }) => {
  useEffect(() => {
    ...
    return (
      <div className="w-full h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center p-8 bg-white rounded-lg shadow-lg max-w-md">
          <span className="material-icons text-6xl text-red-500 mb-4 block">block</span>
          <h2 className="text-xl font-semibold text-gray-800 mb-2">Akses Tidak Diizinkan</h2>
          <p className="text-gray-600 mb-4">Fitur screening hanya tersedia untuk siswa dan karyawan.</p>
          <button
            onClick={handleExit}
  ...
  return <ScreeningWelcomePage onComplete={handleScreeningComplete} onExit={handleExit} user={user} />
}
