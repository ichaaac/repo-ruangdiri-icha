// src/pages/user/student/OnboardingSplashScreen.jsx - Splash Screen Onboarding untuk Student

import React from 'react';
import { useNavigate } from 'react-router-dom';
import { useAuth } from '../../../hooks/useAuth';

const StudentOnboardingSplashScreen = () => {
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 md:p-12">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-xl text-gray-600 mb-2">
              Mari mulai perjalanan kesehatan mental Anda
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            <div className="text-center p-6 bg-blue-50 rounded-xl">
              ...
              <p className="text-sm text-gray-600">
                Jadwalkan sesi konseling dengan mudah sesuai kebutuhan Anda
              </p>
            </div>
            ...
            <div className="text-center p-6 bg-green-50 rounded-xl">
              ...
              <p className="text-sm text-gray-600">
                Asesmen berkala untuk memantau kondisi kesehatan mental
              </p>
            </div>
            ...
            <div className="text-center p-6 bg-purple-50 rounded-xl">
              ...
              <p className="text-sm text-gray-600">
                Konsultasi langsung dengan konselor melalui chat
              </p>
            </div>
            ...
            <div className="text-center p-6 bg-orange-50 rounded-xl">
              ...
              <p className="text-sm text-gray-600">
                Pantau perkembangan kesehatan mental dari waktu ke waktu
              </p>
            </div>
            ...
            <div className="text-center p-6 bg-red-50 rounded-xl">
              ...
              <p className="text-sm text-gray-600">
                Semua informasi Anda dijaga kerahasiaannya
              </p>
            </div>
          ...
          <div className="bg-gradient-to-r from-blue-500 to-purple-600 rounded-xl p-6 mb-8 text-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-semibold mb-1">Academic Stress Management</h4>
                  <p className="text-sm opacity-90">Bantuan mengelola stres akademik dan ujian</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <span className="material-icons text-sm mt-1">check_circle</span>
                <div>
                  <h4 className="font-semibold mb-1">Peer Support Network</h4>
                  <p className="text-sm opacity-90">Bergabung dengan komunitas siswa lainnya</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <span className="material-icons text-sm mt-1">check_circle</span>
                <div>
                  <h4 className="font-semibold mb-1">Career Counseling</h4>
                  <p className="text-sm opacity-90">Bimbingan untuk perencanaan karir masa depan</p>
                </div>
              </div>
              <div className="flex items-start gap-3">
                <span className="material-icons text-sm mt-1">check_circle</span>
                <div>
                  <h4 className="font-semibold mb-1">Parent Communication</h4>
                  <p className="text-sm opacity-90">Komunikasi dengan orang tua (jika diperlukan)</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 rounded-lg p-6 mb-8">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h4 className="font-semibold text-gray-800 mb-2">Komitmen Privasi Kami</h4>
                <p className="text-sm text-gray-600 mb-3">
                  Semua informasi yang Anda berikan akan dijaga kerahasiaannya sesuai dengan standar keamanan data dan etika konseling profesional. 
                  Data Anda hanya akan digunakan untuk memberikan layanan kesehatan mental yang terbaik.
                </p>
                <ul className="text-sm text-gray-600 space-y-1">
                  ...
                  <li className="flex items-center gap-2">
                    <span className="material-icons text-xs text-green-600">check</span>
                    Akses data terbatas hanya untuk konselor yang ditugaskan
                  </li>
                  <li className="flex items-center gap-2">
                    <span className="material-icons text-xs text-green-600">check</span>
                    Tidak ada data yang dibagikan ke pihak ketiga tanpa persetujuan
                  </li>
                </ul>
              </div>
            </div>
...
export default StudentOnboardingSplashScreen;